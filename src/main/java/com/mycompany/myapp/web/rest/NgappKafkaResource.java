...
@RestController
@RequestMapping("/api/ngapp-kafka")
public class NgappKafkaResource {
    private final Logger log = LoggerFactory.getLogger(NgappKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NgappKafkaResource(KafkaProperties kafkaProperties) {
